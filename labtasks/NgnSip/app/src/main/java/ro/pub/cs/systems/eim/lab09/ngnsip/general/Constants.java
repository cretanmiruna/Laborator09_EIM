...
public interface Constants {
    ...
    final public static String USERNAME = "miru_maria10";
    final public static String IDENTITY_IMPI = "mirumaria";
    final public static String IDENTITY_PASSWORD = "ktxiZcxaWYgLtk6e";
    final public static String DOMAIN = "mirumaria.onsip.com";
    final public static String NETWORK_PCSCF_HOST = "sip.onsip.com";
    final public static int NETWORK_PCSCF_PORT = 5060;
    final public static String NETWORK_REALM = "mirumaria.onsip.com";
